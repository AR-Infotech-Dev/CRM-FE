...
export const companySettingSchema = {
    ...
    sections: [
      {
        ...
        columns: 3,
        fields: [
          { name: "company_name", label: "Company Name", type: "text", required: true, placeholder: "Enter company name", gridSpan: 4 },
      ...
      },
      {
        columns: 1,
        fields: [
          { name: "company_address", label: "Company Address", type: "textarea", rows: 3, placeholder: "Enter company address", gridSpan: 10 },
        ],
      },
      {
      ...
      },
      {
        ...
        fields: [
          ...
          { name: "ticket_include_year", label: "Include Date", type: "radio", options: [{ label: "Yes", value: "y" }, { label: "No", value: "n" },], gridSpan: 4, },
          { name: "ticket_no_reset", label: "Reset preference", type: "radio", options: [{ label: "Daily", value: "daily" }, { label: "Monthly", value: "monthly" }, { label: "Yearly", value: "yearly" },], gridSpan: 4, },
        ],
      },
      {
      ...
      },
      {
        ...
        columns: 3,
        fields: [
          { name: "bank_name", label: "Bank Name", type: "input", required: false, placeholder: "Enter bank name", gridSpan: 4 },
          { name: "account_number", label: "Account No ", type: "input", required: false, placeholder: "Enter account no", gridSpan: 4 },
          { name: "ifsc_code", label: "IFSC Code", type: "input", required: false, placeholder: "Enter IFSC code", gridSpan: 4 },
        ],
      },
      {
        columns: 3,
        fields: [
          { name: "branch", label: "Branch", type: "input", required: false, placeholder: "Enter branch", gridSpan: 4 },
        ],
      },
      {
        columns: 3,
...
export const companySettingFallbackColumns = [
  ...FIXED_TABLE_COLUMNS,
  ...buildFallbackColumnsFromKeys(companySettingSchema.defaultColumns, {
    columnMappings: companySettingSchema.columnMappings,
    tableCellConfig: companySettingSchema.tableCellConfig,
  }),
];
